...
-- 2. orders 테이블을 다시 생성, customer와 관계 형성
CREATE TABLE orders (
    order_id INTEGER PRIMARY KEY,
    order_date DATE NOT NULL,
    total_amount REAL NOT NULL,
    customer_id INTEGER,
    -- customers 테이블의 customer_id를 참조하도록 외래 키 설정
    FOREIGN KEY (customer_id) REFERENCES customers(customer_id)
);

-- 3-1. orders 테이블에 Integer 타입의 price 컬럼 추가
ALTER TABLE orders ADD COLUMN price INTEGER;

-- 3-2. orders 테이블의 total_amount 컬럼 삭제
ALTER TABLE orders DROP COLUMN total_amount;

-- 4. orders 테이블에 데이터 삽입
INSERT INTO orders (order_date, customer_id, price) VALUES ('2023-07-15', 1, 50);
INSERT INTO orders (order_date, customer_id, price) VALUES ('2023-07-16', 2, 75);
INSERT INTO orders (order_date, customer_id, price) VALUES ('2023-07-17', 3, 30);

-- 5. orders의 모든 데이터 조회, customers의 name도 함께 출력
SELECT 
    o.order_id, 
    c.name, 
    o.order_date, 
